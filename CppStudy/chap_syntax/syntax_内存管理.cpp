...
namespace TEST_STRUCT
{
	...
	// test0: C++中的内存分区
	void syntax_memory_management_module::test0() 
	{
		std::cout << "\n\n\n\n" << std::endl;
	...
	// test1: C中的动态内存的基本使用
	void syntax_memory_management_module::test1()
	{
		std::cout << "\n\n\n\n" << std::endl;
	...
	// test2: C++中的动态内存的基本使用
	void syntax_memory_management_module::test2()
	{
		std::cout << "\n\n\n\n" << std::endl;
	...
	// test3: 结构体中的内存对齐
	void syntax_memory_management_module::test3()
	{
		std::cout << "\n\n\n\n" << std::endl;
	...
	void syntax_memory_management_module::test4()
	{
	...
	void syntax_memory_management_module::test5()
	{
	...
	void syntax_memory_management_module::test6()
	{


	}

	void syntax_memory_management_module::test7()
	{
	}
