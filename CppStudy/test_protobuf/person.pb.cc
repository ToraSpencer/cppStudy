...
const ::uint32_t
    TableStruct_person_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::Person, _impl_.hobbies_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::PersonList, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::PersonList, _impl_.people_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::Person)},
        {11, -1, -1, sizeof(::PersonList)},
};
...
inline PROTOBUF_NDEBUG_INLINE Person::Impl_::Impl_(
    ...
    const Impl_& from, const ::Person& from_msg)
      : hobbies_{visibility, arena, from.hobbies_},
...
constexpr auto Person::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(Person, _impl_.hobbies_) +
          decltype(Person::_impl_.hobbies_)::
...
const ::_pbi::TcParseTable<2, 3, 0, 26, 2> Person::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::FastUR1,
     {26, 63, 0, PROTOBUF_FIELD_OFFSET(Person, _impl_.hobbies_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string name = 1;
    ...
    // repeated string hobbies = 3;
    {PROTOBUF_FIELD_OFFSET(Person, _impl_.hobbies_), 0, 0,
...
// @@protoc_insertion_point(message_clear_start:Person)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* Person::_InternalSerialize(
          ...
          // repeated string hobbies = 3;
          for (int i = 0, n = this_._internal_hobbies_size(); i < n; ++i) {
            const auto& s = this_._internal_hobbies().Get(i);
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "Person.hobbies");
          ...
          ::_pbi::Prefetch5LinesFrom7Lines(&this_);
           {
            ...
            {
              total_size +=
                  1 * ::google::protobuf::internal::FromIntSize(this_._internal_hobbies().size());
              for (int i = 0, n = this_._internal_hobbies().size(); i < n; ++i) {
                total_size += ::google::protobuf::internal::WireFormatLite::StringSize(
                    this_._internal_hobbies().Get(i));
              }
            }
          }
           {
...
void Person::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  _this->_internal_mutable_hobbies()->MergeFrom(from._internal_hobbies());
...
void Person::InternalSwap(Person* PROTOBUF_RESTRICT other) {
  ...
  _impl_.hobbies_.InternalSwap(&other->_impl_.hobbies_);
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:PersonList)
}
inline PROTOBUF_NDEBUG_INLINE PersonList::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::PersonList& from_msg)
...
PersonList::PersonList(
  ...
  // @@protoc_insertion_point(copy_constructor:PersonList)
}
inline PROTOBUF_NDEBUG_INLINE PersonList::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
PersonList::~PersonList() {
  // @@protoc_insertion_point(destructor:PersonList)
  SharedDtor(*this);
}
inline void PersonList::SharedDtor(MessageLite& self) {
  PersonList& this_ = static_cast<PersonList&>(self);
  this_._internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  ABSL_DCHECK(this_.GetArena() == nullptr);
  this_._impl_.~Impl_();
}

inline void* PersonList::PlacementNew_(const void*, void* mem,
                                        ::google::protobuf::Arena* arena) {
  return ::new (mem) PersonList(arena);
}
constexpr auto PersonList::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(PersonList, _impl_.people_) +
          decltype(PersonList::_impl_.people_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
  });
  if (arena_bits.has_value()) {
    return ::google::protobuf::internal::MessageCreator::ZeroInit(
        sizeof(PersonList), alignof(PersonList), *arena_bits);
  } else {
    return ::google::protobuf::internal::MessageCreator(&PersonList::PlacementNew_,
                                 sizeof(PersonList),
                                 alignof(PersonList));
  }
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull PersonList::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        &_PersonList_default_instance_._instance,
        &_table_.header,
        nullptr,  // OnDemandRegisterArenaDtor
        ...
        ::google::protobuf::Message::GetNewImpl<PersonList>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &PersonList::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<PersonList>(), &PersonList::ByteSizeLong,
            &PersonList::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
...
const ::google::protobuf::internal::ClassData* PersonList::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(_class_data_.tc_table);
  return _class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 1, 0, 2> PersonList::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::PersonList>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // repeated .Person people = 1;
    {::_pbi::TcParser::FastMtR1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(PersonList, _impl_.people_)}},
  }}, {{
    65535, 65535
  }}, {{
    // repeated .Person people = 1;
    {PROTOBUF_FIELD_OFFSET(PersonList, _impl_.people_), 0, 0,
...
// @@protoc_insertion_point(message_clear_start:PersonList)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* PersonList::_InternalSerialize(
            const MessageLite& base, ::uint8_t* target,
            ::google::protobuf::io::EpsCopyOutputStream* stream) {
          const PersonList& this_ = static_cast<const PersonList&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
        ::uint8_t* PersonList::_InternalSerialize(
            ::uint8_t* target,
            ::google::protobuf::io::EpsCopyOutputStream* stream) const {
          const PersonList& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:PersonList)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          // @@protoc_insertion_point(serialize_to_array_end:PersonList)
          return target;
        }

#if defined(PROTOBUF_CUSTOM_VTABLE)
        ::size_t PersonList::ByteSizeLong(const MessageLite& base) {
          const PersonList& this_ = static_cast<const PersonList&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
        ::size_t PersonList::ByteSizeLong() const {
          const PersonList& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:PersonList)
          ::size_t total_size = 0;
...
void PersonList::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:PersonList)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:PersonList)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
