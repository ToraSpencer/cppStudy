...
virtualModule* exception_std_exception_module::getInstance()		// 线程不安全的单例模式
{
	if (nullptr != p_moduleIns)
	{
		delete p_moduleIns;
	}
	p_moduleIns = new exception_std_exception_module;
	return p_moduleIns;
}
...
void exception_std_exception_module::test0(void)
{
	std::cout << "\n\n\n\n" << std::endl;
	std::cout << "test0: 对标准异常的测试" << std::endl;

	TEST_STD_EXCEPTION1::classFoo foo1;

	try
	{
		// 测试一个有异常风险的语句：
		TEST_STD_EXCEPTION1::classFoo foo2("xiaohong", -1);
	}
...
void exception_std_exception_module::test1(void)
{

}

void exception_std_exception_module::test2(void) {}



void exception_std_exception_module::test3(void) {}



void exception_std_exception_module::test4(void) {}



void exception_std_exception_module::test5(void) {}



void exception_std_exception_module::test6(void) {}
